...
# Single-mode presentation: viewers see one live mode. Override with
# NEXT_PUBLIC_SINGLE_MODE=false for a build that keeps the rehearsal UI.
export NEXT_PUBLIC_SINGLE_MODE="${NEXT_PUBLIC_SINGLE_MODE:-true}"
...
echo "  NEXT_PUBLIC_SINGLE_MODE=$NEXT_PUBLIC_SINGLE_MODE"
