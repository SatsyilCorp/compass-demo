  ...
  return (
    ...
    >
      ...
      <div className="mt-3 flex items-center justify-between gap-2 border-t border-border-2 pt-2">
        <span className="rounded-full bg-surface-2 px-2 py-0.5 text-[8.5px] font-bold uppercase tracking-wide text-text-subtle">
          {component.deployment === "scale" ? "Scale path" : component.deployment}
        </span>
          ...
          <div className="flex flex-col gap-4 xl:flex-row xl:items-end xl:justify-between">
            <div>
              ...
              <p className="mt-1 max-w-3xl text-xs leading-5 text-text-muted">
                Every box maps to a deployed service, a conditional security service, or an explicit logical boundary from the SAM template and accepted architecture decisions.
              </p>
            </div>
