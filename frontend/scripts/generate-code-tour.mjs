...
const MANIFEST = {
  ...
  "/admin/delivery/": [
    ...
    { path: "template.yaml", start: 1, end: 60,
      title: "One template provisions everything",
      note: "The same file the RMF generator reads - compliance cannot drift from infrastructure." },
  ],
  "/ingest/": [
    { path: "statemachines/intake.asl.yaml",
      title: "Intake workflow (Step Functions)",
      note: "The glue: S3 event -> EventBridge -> these states. Fetch, validate, persist or quarantine." },
