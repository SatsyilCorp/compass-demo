  ...
  return (
    <AppShell requireRole={["poweruser"]}>
      <PageHeader
        ...
        lead={rehearsal ? "Use the seven-element path with deterministic fixtures, explicit user actions, and persistent rehearsal labels. This path does not call public authorities or claim operational cloud results." : SINGLE_LIVE_MODE ? "Use the seven-element path with live public evidence as the default. AWS polls each authority at a responsible cadence while the browser projects retained changes in near real time." : "Use the seven-element path with live public evidence as the default. AWS polls each authority at a responsible cadence while the browser projects retained changes in near real time. Enter the separate rehearsal workspace only by explicit choice."}
