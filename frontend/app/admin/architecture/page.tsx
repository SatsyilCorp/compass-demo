...
import { Boxes, ExternalLink, LogIn, Network } from "lucide-react";
      ...
      <div className="flex min-h-[calc(100vh-2.75rem)] flex-col bg-bg">
        ...
        <main id="main-content" tabIndex={-1} className="min-w-0 flex-1 px-4 py-6 sm:px-6 sm:py-8 xl:px-8">
          <div className="mx-auto flex w-full max-w-[1480px] flex-col gap-6">
            <PageHeader
              kicker="System view | Deployed topology"
              title="Architecture Explorer"
              lead="Follow every request, control message, record, receipt, and security boundary across the deployed mission workflow and the production-scale synthetic data path. Select any box to inspect its contract, scaling behavior, recovery path, security controls, and retained proof."
